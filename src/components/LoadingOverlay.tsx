...
export function LoadingOverlay({ isLoading, isRendering }: Props) {
  ...
  return (
    <div
      className="absolute inset-0 bg-black/50 backdrop-blur-sm z-50 flex flex-col items-center justify-center text-app"
      role="status"
      aria-live="polite"
    >
      ...
      <p className="text-sm text-muted mt-2">数据量较大时可能需要几秒钟</p>
    </div>
  );
}
